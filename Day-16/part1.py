...
class Packet(ABC):
    ...
    def version_sum(self) -> int:
        """For a packet, return the version sum of it and its sub-packets if applicable"""
        pass
...
class LiteralValuePacket(Packet):
    ...
    def version_sum(self) -> int:
        """For a literal value packet, just return the version number"""
        return self.version
...
class OperatorPacket(Packet):
    ...
    def version_sum(self) -> int:
        """Calculate the version sum of the sub-packets plus the packet itself"""
